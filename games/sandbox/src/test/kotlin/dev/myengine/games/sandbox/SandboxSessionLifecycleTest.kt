 ...
 *
 * Save format v11 persists `state`, active status effects, effective enemy components, tower upgrade branch/tier/targeting-mode markers, per-tower metrics, the data-defined map identity,
