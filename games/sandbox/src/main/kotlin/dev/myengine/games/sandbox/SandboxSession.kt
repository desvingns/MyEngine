 ...
 *
 * SAVE SOUNDNESS: [SandboxSaveCodec] v16 persists `state`, active status effects, effective enemy components, player-placed buildings, construction sites, terminal run status/summary, selected
 ...
 * state are part of the v16 save so continuation does not restart randomness, lose job progress,
