...
Regenerated by me-docs at close-out. Last updated: 2026-08-03 (ENG-033 scope unblock).

## Current next action

ENG-032 is complete. ENG-033 (colonist needs MVP) is now eligible for `/me --feature --next`
through its accepted authored colony scope with named COL-FRs.

## Active specs / roadmap

- ENG-001, ENG-003, ENG-031, ENG-004, and ENG-032 are done; ENG-033 is the next colony candidate.
...
- ENG-033's authored scope satisfies the colony re-entry trigger. MySD TD Gate 1 is accepted but is not
  treated as evidence for colony behavior; future colony cards need their own named FRs or a PROC-015 bridge.
