...
Regenerated by me-docs at close-out. Last updated: 2026-08-03 (ENG-006 close-out).

## Current next action

ENG-006 (seeded procedural map generation) is complete. Review the remaining accepted backlog before the next
`/me --feature --next` run.

## Active specs / roadmap

- ENG-001, ENG-003, ENG-031, ENG-004, ENG-032, ENG-033, and ENG-006 are done.
