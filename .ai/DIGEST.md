...
Regenerated by me-docs at close-out. Last updated: 2026-08-02 (ENG-032 close-out).

## Current next action

ENG-032 is complete. The next candidate is ENG-033 (colonist needs MVP), subject to the
vision-only colony demand gate.

## Active specs / roadmap

- ENG-001, ENG-003, ENG-031, and ENG-004 are done; remaining colony order is ENG-032.
