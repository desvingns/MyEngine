...
Regenerated by me-docs at close-out. Last updated: 2026-08-03 (ENG-017 close-out).

## Current next action

ENG-017 (research/tech tree + unlock gating) is complete. Review the remaining accepted backlog before the next
`/me --feature --next` run.

## Active specs / roadmap

- ENG-001, ENG-003, ENG-031, ENG-004, ENG-032, ENG-033, ENG-006, and ENG-017 are done.
