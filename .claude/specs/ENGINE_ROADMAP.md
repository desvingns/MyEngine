...
| Desktop content hot-reload | DX-004 | agent pipeline | - | **done** (2026-08-04; Android-free desktop WatchService with debounced validate-then-restart, same-seed deterministic reload, typed invalid-pack errors preserving last-good scenario, CLI watch/pack/seed options, focused tests, and balance-iteration docs) |
...
| Spec board backsync | PROC-001 | process | - | **done** (2026-08-04; deterministic source-bundle stale report, targeted `-Apply`, external-write guard, quoted CSV contract tests) |
