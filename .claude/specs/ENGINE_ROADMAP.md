...
3. P1 opener: ENG-002 (done) -> ENG-013 (done) -> ENG-008 (done) -> ENG-015 (done) -> ENG-030
   ...
   -> ENG-032 (next exact item).
   ENG-001, ENG-003, ENG-031, and ENG-004 are complete; ENG-032 is the next colony-slice card with demand 2.
   The remaining colony slice (ENG-004 -> ENG-032) remains deferred until a colony/MySD spec
   supplies named FRs (see Plane/15). Colony demand remains vision-only.
